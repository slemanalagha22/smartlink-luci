...
wget $B/luci-theme-smartlink_1.1.5-1_all.ipk
wget $B/luci-app-smartlink_1.1.5-1_all.ipk
opkg install luci-theme-smartlink_1.1.5-1_all.ipk luci-app-smartlink_1.1.5-1_all.ipk
```
